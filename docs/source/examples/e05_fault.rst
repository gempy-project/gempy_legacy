...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_examples_e05_fault.py>`
        to download the full example code

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_examples_e05_fault.py:
...
.. image-sg:: /examples/images/sphx_glr_e05_fault_001.png
   :alt: Cell Number: mid Direction: y
   :srcset: /examples/images/sphx_glr_e05_fault_001.png
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    <gempy_viewer.modules.plot_2d.visualization_2d.Plot2D object at 0x7f8aa4fe7460>
...
.. image-sg:: /examples/images/sphx_glr_e05_fault_002.png
   :alt: e05 fault
   :srcset: /examples/images/sphx_glr_e05_fault_002.png
   :class: sphx-glr-single-img
...
.. rst-class:: sphx-glr-horizontal
    ...
    *
      ...
      .. image-sg:: /examples/images/sphx_glr_e05_fault_003.png
         :alt: Cell Number: mid Direction: y
         :srcset: /examples/images/sphx_glr_e05_fault_003.png
         :class: sphx-glr-multi-img

    *

      .. image-sg:: /examples/images/sphx_glr_e05_fault_004.png
         :alt: Cell Number: mid Direction: x
         :srcset: /examples/images/sphx_glr_e05_fault_004.png
         :class: sphx-glr-multi-img
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    <gempy_viewer.modules.plot_3d.vista.GemPyToVista object at 0x7f8aa1ed8d90>
...
.. _sphx_glr_download_examples_e05_fault.py:
