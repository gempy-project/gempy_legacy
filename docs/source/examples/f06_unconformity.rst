...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_examples_f06_unconformity.py>`
        to download the full example code

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_examples_f06_unconformity.py:
...
.. image-sg:: /examples/images/sphx_glr_f06_unconformity_001.png
   :alt: Cell Number: mid Direction: y
   :srcset: /examples/images/sphx_glr_f06_unconformity_001.png
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    <gempy_viewer.modules.plot_2d.visualization_2d.Plot2D object at 0x7f8af03fe200>
...
.. rst-class:: sphx-glr-horizontal
    ...
    *
      ...
      .. image-sg:: /examples/images/sphx_glr_f06_unconformity_002.png
         :alt: Cell Number: mid Direction: y
         :srcset: /examples/images/sphx_glr_f06_unconformity_002.png
         :class: sphx-glr-multi-img

    *

      .. image-sg:: /examples/images/sphx_glr_f06_unconformity_003.png
         :alt: Cell Number: mid Direction: x
         :srcset: /examples/images/sphx_glr_f06_unconformity_003.png
         :class: sphx-glr-multi-img
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    <gempy_viewer.modules.plot_2d.visualization_2d.Plot2D object at 0x7f8aa29b72b0>
...
.. _sphx_glr_download_examples_f06_unconformity.py:
